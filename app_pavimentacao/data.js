...
export const MATERIALS = [
    ...
    { id: 'brita', name: 'Brita Graduada Simples', k: 1.0, minCBR: 80, type: 'granular' },
    { id: 'macadame', name: 'Macadame Hidráulico', k: 1.0, minCBR: 80, type: 'granular' },
    { id: 'solo_brita', name: 'Solo-Brita (50/50)', k: 1.0, minCBR: 60, type: 'granular' },
    ...
    { id: 'solo_melhorado', name: 'Solo Melhorado com Cimento', k: 1.0, minCBR: 20, type: 'granular' },
    { id: 'solo_local', name: 'Solo Local (Subleito)', k: 1.0, minCBR: 2, type: 'soil' },
    { id: 'areia', name: 'Areia / Solo Arenoso', k: 1.0, minCBR: 10, type: 'granular' }
];
