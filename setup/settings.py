...
if not DEBUG:
    ...
    if 'test' in sys.argv:
        ...
        # Disable SSL redirect locally to allow HTTP requests from Nginx/local tools
        SECURE_SSL_REDIRECT = False # config('SECURE_SSL_REDIRECT', default=True, cast=bool)
    # HSTS settings
